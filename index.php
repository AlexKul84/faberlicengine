                    ...
                    <div class="sl-slide bg-1" data-orientation="horizontal" data-slice1-rotation="-25" data-slice2-rotation="-25" data-slice1-scale="2" data-slice2-scale="2">
                        <div class="sl-slide-inner">
                            ...
                            <div class="blockquote">
                                <form name="order" method="post">
                                <h3 class="f_bold">СКИДКА 20% НА ВСЮ ПРОДУКЦИЮ ПОСЛЕ РЕГИСТРАЦИИ!</h3>
                                </form>
                                <form name="order" method="post">
...
<!--                        <div class="sl-slide-inner">-->
<!--                            <div class="blockquote">-->
<!--                                <h3 class="f_bold">НАБОР "ДОМ ФАБЕРЛИК" ВСЕГО ЗА 1 РУБ. ПРИ РЕГИСТРАЦИИ!</h3>-->
<!--                                <h3 class="f_bold">Акция действует до 2-го сентября</h3>-->
<!--                                <form name="order" method="post">-->
...
<!--                            <div class="blockquote">-->
<!--                                <form name="order" method="post">-->
<!--                                    <h2 class="f_bold">Заказывай продукцию-->
...
<!--                                        из каталога со скидкой 20% сразу после бесплатной регистрации!-->
<!--                                    </h2>-->
<!--                                </form>-->
<!--                                <form name="order" method="post">-->
<!--                                    <button class="btn go-to-btn margin-right-btn" onclick="window.open('https://faberlic.com/register?sponsor=1000373967370&lang=ru'); yaCounter45566292.reachGoal('ORDERREG'); return true;" name="order2">ПОЛУЧИТЬ СКИДКУ</button>-->
<!--                                    <a href="#catalog" class="btn send-btn margin-right-btn down-btn page-scroll">СМОТРЕТЬ КАТАЛОГ</a>-->
<!--                                </form>-->
<!--                            </div>-->
<!--                        </div>-->
<!--                    </div>-->
                    ...
                    <div class="sl-slide bg-5" data-orientation="horizontal" data-slice1-rotation="3" data-slice2-rotation="3" data-slice1-scale="2" data-slice2-scale="1">
                        <div class="sl-slide-inner">
                            <form name="order" method="post">
                                <h2>
...
<!--                        <h2 class="wow fadeInUp">Получи подарок за регистрацию</h2>-->
<!--                    </div>-->
<!--                    <h3 class="text-justify">-->
<!--                        <img src="img/akcii/akcii.jpg" />-->
<!--                        НАБОР "ДОМ ФАБЕРЛИК" ВСЕГО ЗА 1 РУБ. ПРИ РЕГИСТРАЦИИ!-->
<!--                    </h3>-->
<!--                    <h3 class="text-justify">-->
...
<!---->
<!--                    <form name="order" method="post">-->
<!--                        <button class="btn go-to-btn margin-right-btn" onclick="window.open('https://faberlic.com/register?sponsor=1000373967370&lang=ru'); yaCounter45566292.reachGoal('ORDERREG'); return true;" name="order2">РЕГИСТРАЦИЯ</button>-->
<!--                        <a href="akcii.php" class="btn send-btn margin-left-btn">ПОДРОБНЕЕ ПРО АКЦИИ</a>-->
<!--                    </form>-->
<!--                    <br>-->
<!--                    <a href="#catalog" class="down-btn page-scroll"><span class="fa fa-angle-down"></span></a>-->
<!--                </div>-->
<!--            </div>-->
<!--        </div>-->
<!--    </section>-->
                        ...
                        <div class="owl-carousel" id="about-team">
                                ...
                                <div class="team-item-wrapper">
                                    ...
                                    <div class="team-member-picture-wrapper">
                                        <div class="team-item-picture">
                                            <img src="img/catalogs/catalog6.jpg" alt=""/>
                                        </div>
                                        <div class="team-member-find">
                                            <div class="team-member-find-overlay">
                                                <!-- overlay content -->
                                                <div class="team-member-find-content">
                                                    <a href="https://new.faberlic.com/ru/catalog/showcover?catalogId=BY_06_2021&sponsornumber=706401503" target="_blank" class="block-link">СМОТРЕТЬ КАТАЛОГ</span></a>
                                                </div>
                                                <!-- /overlay content -->
                                            </div>
                                        </div>
                                    ...
                                    <div class="team-item-content">
                                        <h4 class="team-item-title"><a href="cat_by.php" target="_blank">Беларусь Каталог № 06/2021</a></h4>
                                    </div>
                                    <!-- team-member Infos -->
                                </div>
                                <!-- /team-member wrapper-->
                            ...
                            <div class="team-item">
                                ...
                                <div class="team-item-wrapper">
                                    ...
                                    <div class="team-member-picture-wrapper">
                                        <div class="team-item-picture">
                                            <img src="img/catalogs/florange.jpg" alt=""/>
                                        </div>
                                        <div class="team-member-find">
                                            <div class="team-member-find-overlay">
                                                <!-- overlay content -->
                                                <div class="team-member-find-content">
                                                    <a href="https://new.faberlic.com/ru/catalog/showcover?catalogId=BY_florange1_2021&sponsornumber=706401503" target="_blank" class="block-link">СМОТРЕТЬ КАТАЛОГ</span></a>
                                                </div>
                                                <!-- /overlay content -->
                                            </div>
                                        </div>
                                    ...
                                    <!-- team-member Infos -->
                                    <div class="team-item-content">
                                        <h4 class="team-item-title"><a href="Florange_spring_2019_by.php" target="_blank">Беларусь Florange spring-summer 2021</a></h4>
                                    </div>
                                    <!-- team-member Infos -->
                                </div>
                                <!-- /team-member wrapper-->
                    ...
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane fade in active" id="tab-1">
                            <div class="row">
                                ...
                                <p>
                                    4. Есть желание начать свой бизнс? Сообщите об этом нам и мы расскажем, как это делать онлайн, чтобы Вы могли развиваться самостоятельно и автоматизировать этот процесс!
                                </p>
                                <div class="text-center">
                                    <form name="order" method="post">
